...
public class Texture { 
	...
	public static void init() {
		...
		//fonts
		font24 = FontLoader.loadFont("/mario-font.ttf",24);
		font16 = FontLoader.loadFont("/mario-font.ttf",16);
		
		
		SpriteSheet bs = new SpriteSheet(ImageLoader.loadImage("/sprite.png"));
		SpriteSheet ps = new SpriteSheet(ImageLoader.loadImage("/mario-forms.png"));
		SpriteSheet blo = new SpriteSheet(ImageLoader.loadImage("/background.png"));
		...
		block[6] = bs.crop(48, 144, 48, 48);//goomba
		
		mushroom = bs.crop(48, 144+48, 48, 48);
...
//		startupBackground = ImageLoader.loadImage("d/SuperMarioLogo.png");
